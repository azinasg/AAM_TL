...
Key = ['Instance_Gauss_WL_a=', 'Instance_Heuristic_WN_a=', 'Instance_Logistic_a=', 'SUT_Discarded_Source_x=',
       'T_Discarded_Source_x=', 'SUT_Discarded_Source_V2_x=', 'T_Discarded_Source_V2_x=', 'Azin_a=',
       'Instance_Heuristic_a=']
...
for x in range(num_plots):
    alpha = x/10.0
    with open(r'/Users/azinasgarian/Documents/Research/results/CK+_res3/' + Key[8] +
